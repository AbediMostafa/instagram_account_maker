...
const routes: Array<RouteRecordRaw> = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: "user",
                props: true,
                component: () => import("@/views/user/UserTemplate.vue"),
                children: [
                    {
                        path: ":id",
                        name: "edit-user",
...

            {
                path: "/quotes",
                name: "quotes",
                component: () => import("@/views/quote/Quotes.vue"),
                meta: {
                    pageTitle: "Quotes",
                    breadcrumbs: ["Quotes"],
                },
...
router.beforeEach((to, from, next) => {
   ...
   // if (to.meta.authPage) {
   //      authStore.getUser() ? next({name: 'dashboard'}) : next()
   //  } else {
   //      authStore.getUser() ? next() : next({name: 'sign-in'})
   //  }
});
